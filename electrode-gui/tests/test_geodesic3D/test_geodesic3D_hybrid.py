#!/usr/bin/env python
''' This script tests geodesic3D_hybrid.py utility function that returns the interpolated electrode coordinates a 3D cost mask (e.g. brain mask).

It takes as inputs four sample voxel coordinates representing the corners of an electrode grid on a mask surface as well as the mask itself used to determine the path on which to traverse. It outputs the predicted coordinates of the electrode grid.
'''
